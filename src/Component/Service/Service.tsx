      ...
      <div className="grid grid-cols-3 mr-10 mt-10 gap-9 w-[80%]">
        {Data.map((treatment, index) => (
          ...
          >
            ...
            <div className="absolute bottom-0 w-full h-1/2  bg-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              ...
              <div className="flex items-center justify-between mt-[5px]  h-8 px-4  w-full bg-[#F1A5CA]">
            ...
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="absolute top-3 left-3 text-[#DC1E7A] size-6 hover:fill-[#D20404]"
            >
              <path
