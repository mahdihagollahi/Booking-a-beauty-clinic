...
<div
            className="absolute  right-[69%] transform -translate-y-14 cursor-pointer "
          ...
          <p className="font-regular text-xs text-[#DC1E7A] mt-2 cursor-pointer">
          فراموشی رمز عبور
          </p>

          <button className="w-full bg-[#DC1E7A]  text-white py-4 rounded-lg mt-24  ">
            دریافت کد
          </button>
        </div>
      </div>
