    ...
    <Fragment>
      <div className="bg-white relative z-10 py-2 mt-4">
        <div className="flex">
          ...
          <div className="hidden md:block mr-[12%] mt-32">
          ...
          <div className="hidden md:block relative -mr-[14.7%] mt-[1%]">
            <Image
              src={ServicePhoto1}
              width={199}
              height={199}
          ...
          <div className="hidden md:block relative -mr-[14.7%] mt-[7.5%]">
            <Image
              src={ServicePhoto4}
              width={199}
              height={199}
          ...
          <div className="hidden md:block relative -mr-[14.7%] mt-[16%]">
            <Image
              src={ServicePhoto3}
              width={199}
              height={199}
